...
- 頻出プロンプトを管理したり、翻訳機能によって内容の把握も素早く行えます。  
- クリップボードへのコピーや、生成した画像等をサムネイルにしてのテンプレート保存も可能です。  
...
- カテゴリ分けで整理（スタイル、キャラクター、ネガティブプロンプトなど）
- 日本語翻訳を登録可能（パーツ選択時に反映）
- 検索フィルタでパーツ抽出可能
...
### テンプレート管理
完成したプロンプトをテンプレートとして保存し、適用ボタンにより即座に呼び出せます。
